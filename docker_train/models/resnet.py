...
def create_stage(in_chan, out_chan, b_num, stride=1, dilation=1, use_se=False, use_askc=False):
    assert out_chan % 4 == 0
    blocks = [Bottleneck(in_chan, out_chan, stride=stride, dilation=dilation, use_se=use_se, use_askc=use_askc),]
